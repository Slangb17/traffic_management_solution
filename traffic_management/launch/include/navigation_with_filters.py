...
def generate_launch_description():
    ...
    mask_yaml_file = LaunchConfiguration('mask') # Added
    ...
    lifecycle_nodes = ['controller_server',
                       ...
                       'waypoint_follower',
                       'velocity_smoother',
                       'filter_mask_server', # Added
                       'costmap_filter_info_server'] # Added
    ...
    declare_mask_yaml_file_cmd = DeclareLaunchArgument(
            'mask',
            default_value=os.path.join(traffic_management_dir, 'maps', 'lane_filter.yaml'),
