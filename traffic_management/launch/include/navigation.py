...
def generate_launch_description():
    ...
    lane_filter_yaml = LaunchConfiguration('lane_filter_yaml')
    ...
    param_substitutions = {
        ...
        'lane_filter_yaml': lane_filter_yaml
    }
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(traffic_management_dir, 'config', 'mir_nav_params.yaml'),
    ...
    declare_lane_filter_yaml = DeclareLaunchArgument(
        'lane_filter_yaml',
        default_value=os.path.join(traffic_management_dir, 'filters', 'lane_filter.yaml'),
        description='Path to lane filter yaml')
    ...
    ld.add_action(declare_lane_filter_yaml)
