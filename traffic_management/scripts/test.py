...
shelf_positions = {
    "MIR_01_goal": [[8.5, 14.0, 1.57], True],
    "MIR_02_goal": [[8.5, 18.0, 1.57], True]
    }

# shelf_positions = {
#     "MIR_01_goal": [[6.0, 17.0, 1.57], True],
#     "MIR_02_goal": [[6.0, 7.0, 4.71], True]
#     }


# shelf_positions = {
#     "MIR_01_goal": [[8.5, 17.0, 1.57], True],
#     "MIR_02_goal": [[8.5, 7.0, 4.71], True]
#     }
...
def main():
    ...
    for robot in robots:
        ...
        if robot == 'MIR_01':
                jobName = 'MIR_01_goal'
                jobProperties = shelf_positions[jobName]
        elif robot == 'MIR_02':
            jobName = 'MIR_02_goal'
            jobProperties = shelf_positions[jobName]
